...
namespace Diamond.Brainz.Utils
{
	...
	{
		private const string TwemojiBaseUrl = "https://raw.githubusercontent.com/twitter/twemoji/master/assets/72x72/{0}.png";

		public static string GetEmojiUrlFromCode(string emojiCode)
		{
			return string.Format(TwemojiBaseUrl, emojiCode);
		}
