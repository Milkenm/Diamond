...
public class TEST_Modal : InteractionModuleBase<SocketInteractionContext>
{
	...
	public async Task Command()
	{
		...
		await Context.Interaction.RespondWithModalAsync<SubmissionForm>("signup_" + Context.User.Id.ToString());
