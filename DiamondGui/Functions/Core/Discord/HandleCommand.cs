...
namespace DiamondGui
{
    ...
    {
        internal static async Task DiscordHandleCommand(SocketMessage _SocketMsg)
        {
            try
            {
                ...
                var _Result = await Command.ExecuteAsync(_Context, _ArgPos, null);
            ...
            {
                ShowException(_Exception, "Core.DiscordHandleCommand()");
            }
        }
    }
}