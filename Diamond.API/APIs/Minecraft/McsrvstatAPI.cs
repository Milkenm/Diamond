...
namespace Diamond.API.APIs.Minecraft
{
    public class McsrvstatAPI
    {
        ...
        public ServerStatus GetServerStatus(string hostname, int? port = null, bool isBedrock = false)
        {
            ...
            if (_cache.GetCachedValue(serverIp) is ServerStatus cachedStatus)
            {
            ...
            if (keepFor > 0)
            {
                ...
                _cache.CacheValue(serverIp, serverStatus, (ulong)keepFor);
            }
