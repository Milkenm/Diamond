...
{
    public partial class Games_Module : ModuleBase<SocketCommandContext>
    {
        [Name("Tic Tac Toe"), Command("tictactoe"), Alias("ttt"), Summary("Play a game of Tic Tac Toe with a friend on Discord.")]
        public async Task TicTacToe(IUser opponent)
        {
            /*
            ...
            */
            try
            {
                ...
                embed.WithDescription($"Host: {Context.User.Mention}\nOpponent: {opponent.Mention}");
                embed.WithImageUrl($"attachment://tictactoe.png");

                await Context.Channel.SendFileAsync(@"C:\Milkenm\Data\teste.png", embed: Embeds.FinishEmbed(embed, Context)).ConfigureAwait(false);
            }
            catch (Exception ex)
            {
        ...
        private static Bitmap[] board = { null, null, null, null, null, null, null, null, null, null };
        private static string[] boardFormats = { ":one:", ":two:", ":three:", ":four:", ":five:", ":six:", ":seven:", ":eight:", ":nine:" };
